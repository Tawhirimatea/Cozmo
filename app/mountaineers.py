...
def cozmo_program(robot: cozmo.robot.Robot):
    ...
    image_settings = [("images/mountaineers.png", Image.BICUBIC),
                      ("images/mountaineers.png", Image.NEAREST)]
    face_images = []
    ...
    robot.say_text("Climb on with the Mountaineers").wait_for_completed()
